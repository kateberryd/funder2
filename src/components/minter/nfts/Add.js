...
const TYPE = ["Wild", "Domestic"];
const DEGREE = ["Slightly Endangered", "Endangered", "Very Endangered"];
const LEGS = ["Four", "Two"]
        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Control
              ...
              className={"mb-3"}
              onChange={async (e) => {
                setAttributesFunc(e, "legs");
              }}
              placeholder="Legs"
            >
              <option hidden>Legs</option>
              {LEGS.map((glass) => (
                <option
